...
while 1:
    ...
    try:
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + " Bilinmeyen Komut Lütfen Tekrar deneyiniz.")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "SMS Gönderilecek Telefon Numarasını +90 Olmadan Girin ( Birden Fazla Numara Giricekseniz Enter Basın ): "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
